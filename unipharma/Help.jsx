...
function HelpPage({ lang, L, perm = { role: 'admin' }, supplierCount = 0, drugCount = 0 }) {
  ...
  const PAGES = [
    ...
    { icon:'💊', th:'ฐานข้อมูลยา', en:'Drug Database', color:'var(--ok)',
      steps_th:['✏ ฟอร์มแก้ไขชื่อยา: แถบม่วง 🔄 CW แสดงชื่ออ้างอิงจากระบบ CW — ฟิลด์ "ชื่อภาษาไทย" และ "ชื่อภาษาอังกฤษ" เป็นชื่อที่แอดมินกำหนดเอง (ว่างไว้ = ใช้ชื่อ CW อัตโนมัติ)',
